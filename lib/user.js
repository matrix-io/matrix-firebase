...
module.exports = {
  ...
  createGroups: function(devices) {
    const key = ref.userGroups.push().key;
    const devicesObject = devices.reduce((obj, value, index) => { // Convert array to object to fit Firebase approach
      obj[index] = value;
      return obj;
    }, {});
    
    refs.userGroups.update({key: devicesObject});
  },
