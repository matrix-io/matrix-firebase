...
module.exports = {
  init: function (userId, deviceId, token, env, cb) {
    ...
    firebaseApp.auth().signInWithCustomToken(token).then(function(user) {
      ...
      firebaseCategoriesRef = firebaseApp.database().ref('categories' );
      ...
      module.exports.refs.categories = firebaseCategoriesRef;
  ...
  refs: {
    ...
    // collection of categories of the app store apps
    categories: firebaseCategoriesRef
  },
  records: {
